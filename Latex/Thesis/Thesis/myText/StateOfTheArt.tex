...
\markred{Maybe a short introduction about the road of poker agents of the last 10 years and what they try to achieve and tackle? Also state that most approaches focus on simplified versions of poker and mainly on Heads-up play}
...
\markred{How much do I want to write here, because it is anyway my topic to present.}
