...
\myfig{Results/withoutHOF/overallfitness.pdf}%% filename in figures folder
  ...
  {Overall fitness of best agent in playing population over 1000 generations. (First experiment)}%% caption
  {Overall fitness of best agent in playing population over 1000 generations. (First experiment)}%% optional (short) caption for table of figures
  {fig:overallfitness_withoutHOF}%% label
\myfig{Results/withoutHOF/progression.pdf}%% filename in figures folder
  {width=1\textwidth,height=1\textheight}%% maximum width/height, aspect ratio will be kept
  {Evolutionary progress in the first experiment for all three individual fitness components over 1000 generations}%% caption
  {Evolutionary progress in the first experiment for all three individual fitness components over 1000 generations}%% optional (short) caption for table of figures
...
\myfig{Results/withoutHOF/dollar_roi.pdf}%% filename in figures folder
  ...
  {Profitability of different playing styles in the first experiment, measured by the percentage \textit{ROI}.}%% caption
  {Profitability of different playing styles in the first experiment, measured by the percentage \textit{ROI}.}%% optional (short) caption for table of figures
  {fig:roi_withoutHOF}%% label
\myfig{Results/withoutHOF/dollar.pdf}%% filename in figures folder
  {width=1\textwidth,height=1\textheight}%% maximum width/height, aspect ratio will be kept
  {Mean dollar won over 1000 generations in the first experiment.}%% caption
  {Mean dollar won over 1000 generations in the first experiment.}%% optional (short) caption for table of figures
...
\myfig{Results/withHOF/overallfitness.pdf}%% filename in figures folder
  {width=1\textwidth,height=1\textheight}%% maximum width/height, aspect ratio will be kept
  {Overall fitness of best agent in playing population over 1000 generations. (Second experiment)}%% caption
  {Overall fitness of best agent in playing population over 1000 generations. (Second experiment)}%% optional (short) caption for table of figures
  {fig:overallfitness_withHOF}%% label
\myfig{Results/withHOF/progression.pdf}%% filename in figures folder
  {width=1\textwidth,height=1\textheight}%% maximum width/height, aspect ratio will be kept
  {Evolutionary progress in the second experiment for all three individual fitness components over 1000 generations}%% caption
  {Evolutionary progress in the second experiment for all three individual fitness components over 1000 generations}%% optional (short) caption for table of figures
  {fig:progression_withHOF}%% label
\myfig{Results/withHOF/histogram.pdf}%% filename in figures folder
  {width=1\textwidth,height=1\textheight}%% maximum width/height, aspect ratio will be kept
  {Fitness of all playing styles including the \textit{HOF Control} agent.}%% caption
  {Fitness of all playing styles including the \textit{HOF Control} agent.}%% optional (short) caption for table of figures
  {fig:histo_withHOF}%% label
...
\myfig{Results/withHOF/dollar_roi.pdf}%% filename in figures folder
  {width=0.7\textwidth,height=0.7\textheight}%% maximum width/height, aspect ratio will be kept
  {Profitability of different playing styles in the second experiment, measured by the percentage \textit{ROI}.}%% caption
  {Profitability of different playing styles in the second experiment, measured by the percentage \textit{ROI}.}%% optional (short) caption for table of figures
  {fig:roi_withHOF}%% label
\myfig{Results/withHOF/dollar.pdf}%% filename in figures folder
  {width=1\textwidth,height=1\textheight}%% maximum width/height, aspect ratio will be kept
  {Mean dollar won over 1000 generations in the second experiment.}%% caption
  {Mean dollar won over 1000 generations in the second experiment.}%% optional (short) caption for table of figures
...
\myfig{Results/withHOFandOPM/overallfitness.pdf}%% filename in figures folder
  {width=1\textwidth,height=1\textheight}%% maximum width/height, aspect ratio will be kept
  {Overall fitness of best agent in playing population over 1000 generations. (Third experiment)}%% caption
  {Overall fitness of best agent in playing population over 1000 generations. (Third experiment)}%% optional (short) caption for table of figures
  {fig:overallfitness_withHOFandOPM}%% label
\myfig{Results/withHOFandOPM/progression.pdf}%% filename in figures folder
  {width=1\textwidth,height=1\textheight}%% maximum width/height, aspect ratio will be kept
  {Evolutionary progress in the third experiment for all three individual fitness components over 1000 generations}%% caption
  {Evolutionary progress in the third experiment for all three individual fitness components over 1000 generations}%% optional (short) caption for table of figures
  {fig:progression_withHOFandOPM}%% label
\myfig{Results/withHOFandOPM/histogram.pdf}%% filename in figures folder
  {width=1\textwidth,height=1\textheight}%% maximum width/height, aspect ratio will be kept
  {Fitness of all playing styles including the \textit{HOF\_OPM Control} agent.}%% caption
  {Fitness of all playing styles including the \textit{HOF\_OPM Control} agent.}%% optional (short) caption for table of figures
...
\myfig{Results/withHOFandOPM/dollar_roi.pdf}%% filename in figures folder
  {width=0.7\textwidth,height=0.7\textheight}%% maximum width/height, aspect ratio will be kept
  {Profitability of different playing styles in the third experiment, measured by the percentage \textit{ROI}.}%% caption
  {Profitability of different playing styles in the third experiment, measured by the percentage \textit{ROI}.}%% optional (short) caption for table of figures
  {fig:roi_withoutHOFandOPM}%% label
\myfig{Results/withHOFandOPM/dollar.pdf}%% filename in figures folder
  {width=1\textwidth,height=1\textheight}%% maximum width/height, aspect ratio will be kept
  {Mean dollar won over 1000 generations in the third experiment.}%% caption
  {Mean dollar won over 1000 generations in the third experiment.}%% optional (short) caption for table of figures
...
A big difference in an agent's playing style can be observed in Figure \ref{fig:player_stats_withHOFandOPM}, which shows the results for the third experiment. The introduction of an opponent model as input to the neural network led to a very different playing style progression over generations. Similar to the first two experiments, agents in this third population also recognized the importance of a small gap between \textit{VPIP} and \textit{PFR}, at least until generation 70, from where on the \textit{VPIP} value starts to diverge from the \textit{PFR} value significantly. From generation 500 onwards the \textit{VPIP} value started to level off at a value of around 22, while the \textit{PFR} value stayed low at around 2. The playing style associated with these values indicates a very tight player, who patiently waits for the best hands and only raises with them. However this kind of player might also trap other players with some tricky plays or might develop a call/re-raise strategy \cite{playing_style}. While this kind of playing style is not considered to be the best, it is by far not the worst strategy. When playing against very static opponents, this strategy might even be advantageous over other tight strategies.
  ...
  {width=1\textwidth,height=1\textheight}%% maximum width/height, aspect ratio will be kept
  {Player statistics (VPIP, PFR, AFq) of best agent in first experiment over 1000 generations.}%% caption
  {Player statistics (VPIP, PFR, AFq) of best agent in first experiment over 1000 generations}%% optional (short) caption for table of figures
  {fig:player_stats_withoutHOF}%% label
  \myfig{Results/withHOF/stats.pdf}%% filename in figures folder
  {width=1\textwidth,height=1\textheight}%% maximum width/height, aspect ratio will be kept
  {Player statistics (VPIP, PFR, AFq) of best agent in second experiment over 1000 generations.}%% caption
  {Player statistics (VPIP, PFR, AFq) of best agent in second experiment over 1000 generations}%% optional (short) caption for table of figures
  {fig:player_stats_withHOF}%% label 
\myfig{Results/withHOFandOPM/stats.pdf}%% filename in figures folder
  {width=1\textwidth,height=1\textheight}%% maximum width/height, aspect ratio will be kept
  {Player statistics (VPIP, PFR, AFq) of best agent in third experiment over 1000 generations.}%% caption
  {Player statistics (VPIP, PFR, AFq) of best agent in third experiment over 1000 generations}%% optional (short) caption for table of figures
