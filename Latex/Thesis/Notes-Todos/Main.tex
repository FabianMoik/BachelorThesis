...
\subitem (2.5) hand rankings (reference to appendix?) \markblue{How to properly do it?}
\subsubitem maybe just briefly explain the basics of hand ranks and then reference to an indepth list?
\subitem (2.6) \markred{also shortly explain what problems algorithms try to tackle (opponent modeling/player typification, etc...), partial information}
