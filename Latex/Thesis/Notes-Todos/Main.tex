...
\subitem \markred{also shortly explain what problems algorithms try to tackle (opponent modeling/player typification, etc...)}
...
\end{itemize}
\subsection{(2.) INTRODUCTION TO POKER \markred{look how people did it}}
\begin{itemize}
