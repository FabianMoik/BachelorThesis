...
std::map<int, std::string> bettingActionsAsString = {{0, "FOLD"}, {1, "CHECK"}, {2, "CALL"}, {3, "RAISE"}};
std::map<int, std::string> tableRoundsAsString = {{0, "PREFLOP"}, {1, "FLOP"}, {2, "TURN"}, {3, "RIVER"}, {4, "SHOWDOWN???"}};

int globalGameCounter = 0;

std::ofstream outputFile("../ConsolOutput/consolOutputGame.txt");
std::ofstream raiseOutputFile("../raiseOutput.txt");
