...
int main() {
    ...
    std::string path = "../LookupTables/0_Reference/nn_weightsGenHOF100PG112.dat";
    //std::string path = "../LookupTables/nn_weightsGen23.dat";
    ...
    runOneGeneration(players, rules, numOfElitePlayersToKeep, 1000);
